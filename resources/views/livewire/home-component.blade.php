    ...
    <div class="container py-5">
        <div class="row align-items-center">
            <div class="col-lg-7 mb-5 mb-lg-0">
                <div class="mb-4">
                    <h5 class="text-success text-uppercase mb-3" style="letter-spacing: 5px;">Need Any Courses</h5>
            ...
            <div class="col-lg-5">
                <div class="card border-0">
                    <div class="card-header bg-light text-center p-4">
                        <h3 class="m-0">Register For A Course</h3>
                    </div>
                    <div class="card-body rounded-bottom bg-primary p-5" style="background-color: darkblue !important; border: 1px solid darkblue !important;">
                        <form>
                            ...
                            <div>
                                <button class="btn btn-dark btn-block border-0 py-3" type="submit">Register Now</button>
                            </div>
                        </form>
                    </div>
                </div>
